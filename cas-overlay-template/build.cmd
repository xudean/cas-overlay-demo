...
@if "%DNAME%" == "" set DNAME=CN=docker.koal.com,OU=SSO,OU=Org,C=US
...
@if "%CERT_SUBJ_ALT_NAMES%" == "" set CERT_SUBJ_ALT_NAMES=dns:example.org,dns:localhost,dns:%COMPUTERNAME%,ip:127.0.0.1,dns:docker.koal.com,ip:10.0.109.80
